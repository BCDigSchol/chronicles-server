...
module.exports = app => {
  ...
  var router = require('express').Router();
    ...
    router.put('/:publicationId/:authorId', limitRate, auth.verifyEditorToken, controller.update);
    // Delete a item with id
    router.delete('/:publicationId/:authorId', limitRate, auth.verifyEditorToken, controller.delete);
    // Delete all item
