...
module.exports = app => {
  ...
  router.put('/:publicationId/:narrationId', limitRate, auth.verifyEditorToken, controller.update);
  // Delete a item with id
  router.delete('/:publicationId/:narrationId', limitRate, auth.verifyEditorToken, controller.delete);
  // Delete all item
